...
(async () => {
  ...
  const kode = 'QAPROD' + UNIQ;
  const nama = 'QA PRODUCT ' + UNIQ;
  ...
  await form().locator('textarea[name="description"]').fill('Produk test QA');
  ...
  console.log('edit desc:', await form().locator('textarea[name="description"]').inputValue());
