...
test.describe('BOT PGINT - Transaksi QRIS @regression', () => {
  test('1. View: Transaksi QRIS tampil @smoke', async ({ page }) => {
    const m = await PgintMasterPage.open(page, 'merchant');
    await m.page.goto('https://backoffice-pg-playground.lentera-app.id/transaction/information/transaction_qris');
