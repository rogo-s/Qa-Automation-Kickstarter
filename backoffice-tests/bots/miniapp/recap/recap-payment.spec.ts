...
test.describe('BOT MINIAPP - Rekap Pembayaran @regression', () => {
  test('1. View: Rekap Pembayaran tampil @smoke', async ({ page }) => {
    const m = await MiniappMasterPage.open(page, 'user'); // reuse portal open
    await m.page.goto('https://miniapps-dashboard-internal-playground.lentera-app.id/recap/recap-payment');
